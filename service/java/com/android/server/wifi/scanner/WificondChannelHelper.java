...
public class WificondChannelHelper extends KnownBandsChannelHelper {
    ...
    public void updateChannels() {
        ...
        if (channels24G == null || channels5G == null || channelsDfs == null || channels6G == null) {
            Log.e(TAG, "Failed to get all channels for band, not updating band channel lists");
        } else if (channels24G.length > 0 || channels5G.length > 0 || channelsDfs.length > 0 || channels6G.length > 0) {
